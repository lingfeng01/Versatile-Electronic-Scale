...
void AT24C04_WritePage(uchar AT24C04_ADDR, uchar addr, uchar *ReaData);               // 写入多个字节到AT24C04
void AT24C04_ReadPage(uchar AT24C04_ADDR, uchar addr, uchar *ReadData, uchar length); // 从AT24C04读取多个字节
